...
1. **Writes `~/MyVault/.vault-kit-path`** — a one-line file containing the absolute path to the kit repo on this machine (e.g. `/Users/yandifarinango/RS42/projects/vault-setup-kit`). This is how the slash command finds the kit later.
